...
|-----|---------|---------|---------|----------|------|-------------|-----------|
| 1 | 1263.4 s | 39.6 s | 1171.6 s | 52.2 s | 8/8 | 7 | `matrix-run-1-2-4/run20260605-091214-N1` |
| 2 | 1241.5 s | 34.7 s | 1155.8 s | 51.0 s | 8/8 | 7 | `matrix-run-1-2-4/run20260605-093318-N1` |
| 3 | 1257.3 s | 34.8 s | 1168.3 s | 54.2 s | 8/8 | 7 | `matrix-run-1-2-4/run20260605-095401-N1` |
...
|-----|---------|------|------|------|-------------|-----------|
| 1 | 503.3 s | 2.50× | 1.25 | 8/8 | 8 | `matrix-run-1-2-4/run20260605-101459-N2` |
| 2 | 500.9 s | 2.51× | 1.26 | 8/8 | 9 | `matrix-run-1-2-4/run20260605-102322-N2` |
| 3 | 490.9 s | 2.56× | 1.28 | 8/8 | 7 | `matrix-run-1-2-4/run20260605-103143-N2` |
...
|-----|---------|------|------|------|-------------|-----------|
| 1 | 313.4 s | 4.01× | 1.00 | 8/8 | 12 | `matrix-run-1-2-4/run20260605-103955-N4` |
| 2 | 309.0 s | 4.07× | 1.02 | 8/8 | 12 | `matrix-run-1-2-4/run20260605-104509-N4` |
| 3 | 302.3 s | 4.16× | 1.04 | 8/8 | 12 | `matrix-run-1-2-4/run20260605-105018-N4` |

### Plots

`matrix-run-1-2-4/plots-20260605T091214Z/` — generated by `scripts/plot.py`:
